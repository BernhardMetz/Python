...
import {
    ...
    TableRow, Checkbox, IconButton, Icon, DialogTitle,
...
function UsersTable(props)
{
    ...
    const recordsTotal = useSelector(({userApp}) => userApp.users.recordsTotal);
    ...
    useEffect(() => {
        ...
        dispatch(Actions.getUsers(searchParams));
    }, [page, order, rowsPerPage, dispatch]);

    useEffect(() => {
        setData(searchText.length === 0 ? users : _.filter(users, item => item.name.toLowerCase().includes(searchText.toLowerCase())))
    }, [users, searchText]);
    ...
    {
        props.history.push('/apps/user/users/' + item.id + '/' + item.name);
    }
                                                                    ...
                                                                    <DialogActions>
                                                                        <Button
                                                                            onClick={(ev) => {
                                                                                    ...
                                                                                    dispatch(Actions.deleteUser(n.id));
                                                                                }
                                                                            }
                                                                            color="primary"
                                                                        >
