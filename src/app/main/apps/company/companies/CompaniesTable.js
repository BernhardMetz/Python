...
import {
    ...
    Checkbox, IconButton, DialogTitle, DialogContent, DialogContentText,
    DialogActions, Button, Icon
...
function CompaniesTable(props)
{
    ...
    const companies = useSelector(({companyApp}) => companyApp.companies.data);
    const recordsTotal = useSelector(({companyApp}) => companyApp.companies.recordsTotal);
    ...
    useEffect(() => {
        ...
        dispatch(Actions.getCompanies(searchParams));
    }, [page, order, rowsPerPage, dispatch]);

    useEffect(() => {
        setData(searchText.length === 0 ? companies : _.filter(companies, item => item.name.toLowerCase().includes(searchText.toLowerCase())))
    ...
    {
        dispatch(Actions.openEditCompanyDialog(item));
    }
                                                                    ...
                                                                    <DialogActions>
                                                                        <Button
                                                                            onClick={(ev) => {
                                                                                    ...
                                                                                    dispatch(Actions.deleteCompany(n.id));
                                                                                }
                                                                            }
                                                                            color="primary"
                                                                        >
