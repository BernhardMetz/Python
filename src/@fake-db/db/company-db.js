    ...
    companies: [
        {
            ...
            'images'          : [
                {
                    'id'  : 0,
                    'url' : 'assets/images/company/a-walk-amongst-friends.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 1,
                    'url' : 'assets/images/company/braies-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 2,
                    'url' : 'assets/images/company/fall-glow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 3,
                    'url' : 'assets/images/company/first-snow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 4,
                    'url' : 'assets/images/company/lago-di-braies.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 5,
                    'url' : 'assets/images/company/lago-di-sorapis.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 6,
                    'url' : 'assets/images/company/never-stop-changing.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 7,
                    'url' : 'assets/images/company/reaching.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 8,
                    'url' : 'assets/images/company/morain-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 9,
                    'url' : 'assets/images/company/yosemite.jpg',
                    'type': 'image'
                }
            ],
            'priceTaxExcl'    : 9.309,
            ...
            'companies'       : [
                {
                    ...
                    'quantity': 1,
                    'total'   : '10.24',
                    'image'   : 'assets/images/company/a-walk-amongst-friends.jpg'
                },
                {
                    'id'      : 2,
                    ...
                    'quantity': 1,
                    'total'   : '24.62',
                    'image'   : 'assets/images/company/lago-di-braies.jpg'
                },
                {
                    'id'      : 3,
                    ...
                    'quantity': 1,
                    'total'   : '49.29',
                    'image'   : 'assets/images/company/never-stop-changing.jpg'
                }
            ],
            'status'         : [
                {
...
mock.onGet('/api/company/companies').reply(() => {
    return [200, companyDB.companies];
});

mock.onGet('/api/company/company').reply((request) => {
    const { companyId } = request.params;
    const response = _.find(companyDB.companies, { id: companyId });
    return [200, response];
});

mock.onPost('/api/company/company/save').reply((request) => {
    const data = JSON.parse(request.data);
    let company = null;

    companyDB.companies = companyDB.companies.map(_company => {
        if (_company.id === data.id) {
            company = data;
            return company
        }
        return _company;
...
mock.onGet('/api/company/orders').reply(() => {
    return [200, companyDB.orders];
});

mock.onGet('/api/company/order').reply((request) => {
    const {orderId} = request.params;
    const response = _.find(companyDB.orders, {'id': orderId});
    return [200, response];
});
