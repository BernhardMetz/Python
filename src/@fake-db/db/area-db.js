    ...
    areas: [
        {
            ...
            'images'          : [
                {
                    'id'  : 0,
                    'url' : 'assets/images/area/a-walk-amongst-friends.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 1,
                    'url' : 'assets/images/area/braies-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 2,
                    'url' : 'assets/images/area/fall-glow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 3,
                    'url' : 'assets/images/area/first-snow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 4,
                    'url' : 'assets/images/area/lago-di-braies.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 5,
                    'url' : 'assets/images/area/lago-di-sorapis.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 6,
                    'url' : 'assets/images/area/never-stop-changing.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 7,
                    'url' : 'assets/images/area/reaching.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 8,
                    'url' : 'assets/images/area/morain-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 9,
                    'url' : 'assets/images/area/yosemite.jpg',
                    'type': 'image'
                }
            ],
            'priceTaxExcl'    : 9.309,
            ...
            'areas'       : [
                {
                    ...
                    'quantity': 1,
                    'total'   : '10.24',
                    'image'   : 'assets/images/area/a-walk-amongst-friends.jpg'
                },
                {
                    'id'      : 2,
                    ...
                    'quantity': 1,
                    'total'   : '24.62',
                    'image'   : 'assets/images/area/lago-di-braies.jpg'
                },
                {
                    'id'      : 3,
                    ...
                    'quantity': 1,
                    'total'   : '49.29',
                    'image'   : 'assets/images/area/never-stop-changing.jpg'
                }
            ],
            'status'         : [
                {
...
mock.onGet('/api/area/areas').reply(() => {
    return [200, areaDB.areas];
});

mock.onGet('/api/area/area').reply((request) => {
    const { areaId } = request.params;
    const response = _.find(areaDB.areas, { id: areaId });
    return [200, response];
});

mock.onPost('/api/area/area/save').reply((request) => {
    const data = JSON.parse(request.data);
    let area = null;

    areaDB.areas = areaDB.areas.map(_area => {
        if (_area.id === data.id) {
            area = data;
            return area;
        }
...
mock.onGet('/api/area/orders').reply(() => {
    return [200, areaDB.orders];
});

mock.onGet('/api/area/order').reply((request) => {
    const {orderId} = request.params;
    const response = _.find(areaDB.orders, {'id': orderId});
    return [200, response];
});
