    ...
    users: [
        {
            ...
            'images'          : [
                {
                    'id'  : 0,
                    'url' : 'assets/images/user/a-walk-amongst-friends.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 1,
                    'url' : 'assets/images/user/braies-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 2,
                    'url' : 'assets/images/user/fall-glow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 3,
                    'url' : 'assets/images/user/first-snow.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 4,
                    'url' : 'assets/images/user/lago-di-braies.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 5,
                    'url' : 'assets/images/user/lago-di-sorapis.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 6,
                    'url' : 'assets/images/user/never-stop-changing.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 7,
                    'url' : 'assets/images/user/reaching.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 8,
                    'url' : 'assets/images/user/morain-lake.jpg',
                    'type': 'image'
                },
                {
                    'id'  : 9,
                    'url' : 'assets/images/user/yosemite.jpg',
                    'type': 'image'
                }
            ],
            'priceTaxExcl'    : 9.309,
            ...
            'users'       : [
                {
                    ...
                    'quantity': 1,
                    'total'   : '10.24',
                    'image'   : 'assets/images/user/a-walk-amongst-friends.jpg'
                },
                {
                    'id'      : 2,
                    ...
                    'quantity': 1,
                    'total'   : '24.62',
                    'image'   : 'assets/images/user/lago-di-braies.jpg'
                },
                {
                    'id'      : 3,
                    ...
                    'quantity': 1,
                    'total'   : '49.29',
                    'image'   : 'assets/images/user/never-stop-changing.jpg'
                }
            ],
            'status'         : [
                {
...
mock.onGet('/api/user/users').reply(() => {
    return [200, userDB.users];
});

mock.onGet('/api/user/user').reply((request) => {
    const { userId } = request.params;
    const response = _.find(userDB.users, { id: userId });
    return [200, response];
});

mock.onPost('/api/user/user/save').reply((request) => {
...
mock.onGet('/api/user/orders').reply(() => {
    return [200, userDB.orders];
});

mock.onGet('/api/user/order').reply((request) => {
    const {orderId} = request.params;
    const response = _.find(userDB.orders, {'id': orderId});
    return [200, response];
});
